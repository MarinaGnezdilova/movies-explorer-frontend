  ...
  return (
    ...
    <div className="AboutProject">
      ...
      <div className="AboutProject__graph">
        <div className="AboutProject__graph-element-first AboutProject__graph-element">1 неделя</div>
        <div className="AboutProject__graph-element-second AboutProject__graph-element">4 недели</div>
